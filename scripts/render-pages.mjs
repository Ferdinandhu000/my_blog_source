...
write('en/index.html', fs.readFileSync(path.join(dist, 'index.html'), 'utf8')
  ...
  .replace('Ferdinand Hu 的个人博客：三维档案、技术笔记与项目记录。', 'Ferdinand Hu’s blog: a 3D archive of articles, technology and projects.')
