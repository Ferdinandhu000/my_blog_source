...
function shell(title, description, body, options = {}) {
  ...
  return `<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#111813"><title>${escape(title)} · FerdinandHu</title><meta name="description" content="${escape(description)}"><link rel="canonical" href="${origin}${url}"><link rel="icon" href="/favicon.svg" type="image/svg+xml"><link rel="stylesheet" href="/blog.css"><link rel="stylesheet" href="/katex.min.css"><link rel="stylesheet" href="/highlight.css"><script async src="https://busuanzi.ibruce.info/busuanzi/2.3/busuanzi.pure.mini.js"></script></head><body><a class="skip-link" href="#content">跳到正文</a><header class="blog-header"><a class="wordmark" href="/">HJ<span> / ARCHIVE</span></a><nav aria-label="主导航">${links}</nav></header><div class="site-grid"><main id="content">${body}</main>${aside ? `<aside class="site-aside">${aside}</aside>` : ''}</div><footer class="blog-footer">© Ferdinand Hu · <a href="https://github.com/LBEILC/RhineLabUI">三维界面基于 RhineLabUI</a> · <a href="/licenses/RHINELABUI-LICENSE">MIT 许可</a></footer></body></html>`;
}
function toc(html) {
