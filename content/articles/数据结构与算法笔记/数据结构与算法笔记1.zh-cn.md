---
title: "算法笔记1——各类排序算法"
title_en: 'Algorithm Notes I: Comparative Analysis of Core Sorting Algorithms'
...
```
**注意** ： heapify方法用了递归思想但是不必写终止条件，原因是当遍历到末尾元素时，largest的下边还是该元素本身，不会执行最后的if语句，自然递归结束
