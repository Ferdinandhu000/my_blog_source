---
title: "算法笔记2——栈、队列与链表"
title_en: 'Algorithm Notes II: Fundamental Data Structures - Stacks, Queues, and Linked Lists'
...
`PriorityQueue`也实现了`Queue`接口，在[最小生成树](</p/algorithm-notes-iii-graph-and-tree-traversal-binary-search-trees-bfs-and-dfs/#最小生成树(mst)>)部分会有介绍。
